...
export default function ContactoForm() {
  ...
  const validate = () => {
    ...
    if (!telefono && !email) {
      newErrors._contacto = 'Debe ingresar su teléfono o su correo electrónico.'
    }
  ...
  return (
    <form onSubmit={handleSubmit} className='grid gap-4 max-w-xl'>
      ...
      <div>
        <label className='text-sm text-neutral-700'>Tu correo electrónico</label>
        <input
          name='email'
          type='email'
          value={form.email}
      ...
      <div>
        <label className='text-sm text-neutral-700'>Tu teléfono (8 dígitos)</label>
        <input
          name='telefono'
          type='text'
          inputMode='numeric'
      ...
      <div>
        <label className='text-sm text-neutral-700'>Tu mensaje (opcional)</label>
        <textarea
          name='mensaje'
          rows={8}
          value={form.mensaje}

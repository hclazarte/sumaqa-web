    ...
    <main className="min-h-screen bg-white">
      ...
      <Section>
        <p className="mt-4 max-w-4xl text-base sm:text-lg leading-7 text-slate-700">
          La Asociación para el Desarrollo Integral de las Familias Suma Qamaña,
          fue fundada en fecha 22 de julio del año 2010 y refundada en fecha 25
          de mayo de 2022, con participación equitativa e igualitaria de sus
          miembros asociados, constituida al margen de ideologías políticas,
          credos religiosos y de toda forma de discriminación de género, social
          y racial. Su denominación actual es Fundación Suma Qamaña.
        </p>
      </Section>

      <Section title="Objetivo general">
        <p>
          El objetivo general de la <strong>Fundación Suma Qamaña (SQ)</strong>{" "}
          es brindar atención interdisciplinaria (área legal, social,
          psicológica y pedagógica) especializada en materia{" "}
          <strong>
            familiar, niñez y adolescencia y violencia contra la mujer
          </strong>{" "}
          a nivel departamental y nacional; promover el{" "}
          <strong>desarrollo integral de la persona humana</strong> y fomentar
          la <strong>restauración de las relaciones familiares</strong> por
          medio de talleres, seminarios y consejerías, y ejecutar proyectos y
          programas de interés social, económico y cultural para el “Vivir
          Bien”.
        </p>
      </Section>
      ...
      <Section title="Misión">
        <p>
          Identificar, planificar, formular, ejecutar, controlar y evaluar
          acciones de <strong>desarrollo integral comunitario</strong>, con
          estrategias sostenibles y sustentables en favor y beneficio de los
          sectores que se encuentran en situaciones de pobreza, mejorando la
          calidad de vida.
        </p>
      </Section>
      ...
      <Section title="Visión">
        <p>
          Contribuir en la <strong>construcción de una sociedad digna</strong>,
          erradicando la exclusión social y la pobreza de manera equitativa y
          económicamente productiva, a través del desarrollo integral
          comunitario con igualdad de oportunidades y fortalecimiento del
